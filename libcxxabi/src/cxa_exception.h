...
struct _LIBCXXABI_HIDDEN __cxa_exception {
...
#else
    void (_LIBCXXABI_DTOR_FUNC* _LIBCXXABI_PTRAUTH(ptrauth_key_function_pointer, 1, "__cxa_exception::exceptionDestructor") exceptionDestructor)(void*);
#endif
    std::unexpected_handler _LIBCXXABI_PTRAUTH(ptrauth_key_function_pointer, 1, "__cxa_exception::unexpectedHandler") unexpectedHandler;
    std::terminate_handler _LIBCXXABI_PTRAUTH(ptrauth_key_function_pointer, 1, "__cxa_exception::terminateHandler") terminateHandler;
    ...
    const unsigned char* _LIBCXXABI_PTRAUTH(ptrauth_key_process_dependent_data, 1, "__cxa_exception::actionRecord") actionRecord;
    const unsigned char* _LIBCXXABI_PTRAUTH(ptrauth_key_process_dependent_data, 1, "__cxa_exception::languageSpecificData") languageSpecificData;
    void* _LIBCXXABI_PTRAUTH(ptrauth_key_process_dependent_data, 1, "__cxa_exception::catchTemp") catchTemp;
    void* _LIBCXXABI_PTRAUTH(ptrauth_key_process_dependent_data, 1, "__cxa_exception::adjustedPtr") adjustedPtr;
#endif
