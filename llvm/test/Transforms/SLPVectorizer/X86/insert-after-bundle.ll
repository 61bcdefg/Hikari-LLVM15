...
; SSE-NEXT:    [[TMP1:%.*]] = bitcast i8* [[C_ADDR_0352]] to <4 x i8>*
; SSE-NEXT:    [[TMP2:%.*]] = load <4 x i8>, <4 x i8>* [[TMP1]], align 1
; SSE-NEXT:    [[TMP3:%.*]] = bitcast i8* [[D_ADDR_0353]] to <4 x i8>*
; SSE-NEXT:    [[TMP4:%.*]] = load <4 x i8>, <4 x i8>* [[TMP3]], align 1
; SSE-NEXT:    [[TMP5:%.*]] = bitcast i8* [[A_ADDR_0355]] to <4 x i8>*
; SSE-NEXT:    [[TMP6:%.*]] = load <4 x i8>, <4 x i8>* [[TMP5]], align 1
; SSE-NEXT:    [[TMP7:%.*]] = bitcast i8* [[B_ADDR_0351]] to <4 x i8>*
; SSE-NEXT:    [[TMP8:%.*]] = load <4 x i8>, <4 x i8>* [[TMP7]], align 1
; SSE-NEXT:    [[TMP9:%.*]] = icmp ult <4 x i8> [[TMP2]], [[TMP4]]
; SSE-NEXT:    [[TMP10:%.*]] = select <4 x i1> [[TMP9]], <4 x i8> [[TMP8]], <4 x i8> [[TMP6]]
; SSE-NEXT:    [[TMP11:%.*]] = zext <4 x i8> [[TMP10]] to <4 x i32>
; SSE-NEXT:    [[TMP12:%.*]] = mul <4 x i32> [[TMP11]], [[SHUFFLE]]
; SSE-NEXT:    [[TMP13:%.*]] = trunc <4 x i32> [[TMP12]] to <4 x i8>
; SSE-NEXT:    [[TMP14:%.*]] = bitcast i8* [[E_ADDR_0354]] to <4 x i8>*
; SSE-NEXT:    store <4 x i8> [[TMP13]], <4 x i8>* [[TMP14]], align 1
...
; SSE-NEXT:    [[TMP15:%.*]] = bitcast i8* [[ARRAYIDX45]] to <4 x i8>*
; SSE-NEXT:    [[TMP16:%.*]] = load <4 x i8>, <4 x i8>* [[TMP15]], align 1
; SSE-NEXT:    [[TMP17:%.*]] = bitcast i8* [[ARRAYIDX47]] to <4 x i8>*
; SSE-NEXT:    [[TMP18:%.*]] = load <4 x i8>, <4 x i8>* [[TMP17]], align 1
; SSE-NEXT:    [[TMP19:%.*]] = bitcast i8* [[ARRAYIDX49]] to <4 x i8>*
; SSE-NEXT:    [[TMP20:%.*]] = load <4 x i8>, <4 x i8>* [[TMP19]], align 1
; SSE-NEXT:    [[TMP21:%.*]] = bitcast i8* [[ARRAYIDX52]] to <4 x i8>*
; SSE-NEXT:    [[TMP22:%.*]] = load <4 x i8>, <4 x i8>* [[TMP21]], align 1
; SSE-NEXT:    [[TMP23:%.*]] = icmp ult <4 x i8> [[TMP16]], [[TMP18]]
; SSE-NEXT:    [[TMP24:%.*]] = select <4 x i1> [[TMP23]], <4 x i8> [[TMP22]], <4 x i8> [[TMP20]]
; SSE-NEXT:    [[TMP25:%.*]] = zext <4 x i8> [[TMP24]] to <4 x i32>
; SSE-NEXT:    [[TMP26:%.*]] = mul <4 x i32> [[TMP25]], [[SHUFFLE]]
; SSE-NEXT:    [[TMP27:%.*]] = trunc <4 x i32> [[TMP26]] to <4 x i8>
; SSE-NEXT:    [[TMP28:%.*]] = bitcast i8* [[ARRAYIDX56]] to <4 x i8>*
; SSE-NEXT:    store <4 x i8> [[TMP27]], <4 x i8>* [[TMP28]], align 1
...
; SSE-NEXT:    [[TMP29:%.*]] = bitcast i8* [[ARRAYIDX93]] to <4 x i8>*
; SSE-NEXT:    [[TMP30:%.*]] = load <4 x i8>, <4 x i8>* [[TMP29]], align 1
; SSE-NEXT:    [[TMP31:%.*]] = bitcast i8* [[ARRAYIDX95]] to <4 x i8>*
; SSE-NEXT:    [[TMP32:%.*]] = load <4 x i8>, <4 x i8>* [[TMP31]], align 1
; SSE-NEXT:    [[TMP33:%.*]] = bitcast i8* [[ARRAYIDX97]] to <4 x i8>*
; SSE-NEXT:    [[TMP34:%.*]] = load <4 x i8>, <4 x i8>* [[TMP33]], align 1
; SSE-NEXT:    [[TMP35:%.*]] = bitcast i8* [[ARRAYIDX100]] to <4 x i8>*
; SSE-NEXT:    [[TMP36:%.*]] = load <4 x i8>, <4 x i8>* [[TMP35]], align 1
; SSE-NEXT:    [[TMP37:%.*]] = icmp ult <4 x i8> [[TMP30]], [[TMP32]]
; SSE-NEXT:    [[TMP38:%.*]] = select <4 x i1> [[TMP37]], <4 x i8> [[TMP36]], <4 x i8> [[TMP34]]
; SSE-NEXT:    [[TMP39:%.*]] = zext <4 x i8> [[TMP38]] to <4 x i32>
; SSE-NEXT:    [[TMP40:%.*]] = mul <4 x i32> [[TMP39]], [[SHUFFLE]]
; SSE-NEXT:    [[TMP41:%.*]] = trunc <4 x i32> [[TMP40]] to <4 x i8>
; SSE-NEXT:    [[TMP42:%.*]] = bitcast i8* [[ARRAYIDX104]] to <4 x i8>*
; SSE-NEXT:    store <4 x i8> [[TMP41]], <4 x i8>* [[TMP42]], align 1
...
; SSE-NEXT:    [[TMP43:%.*]] = bitcast i8* [[ARRAYIDX141]] to <4 x i8>*
; SSE-NEXT:    [[TMP44:%.*]] = load <4 x i8>, <4 x i8>* [[TMP43]], align 1
; SSE-NEXT:    [[TMP45:%.*]] = bitcast i8* [[ARRAYIDX143]] to <4 x i8>*
; SSE-NEXT:    [[TMP46:%.*]] = load <4 x i8>, <4 x i8>* [[TMP45]], align 1
; SSE-NEXT:    [[TMP47:%.*]] = bitcast i8* [[ARRAYIDX145]] to <4 x i8>*
; SSE-NEXT:    [[TMP48:%.*]] = load <4 x i8>, <4 x i8>* [[TMP47]], align 1
; SSE-NEXT:    [[TMP49:%.*]] = bitcast i8* [[ARRAYIDX148]] to <4 x i8>*
; SSE-NEXT:    [[TMP50:%.*]] = load <4 x i8>, <4 x i8>* [[TMP49]], align 1
; SSE-NEXT:    [[TMP51:%.*]] = icmp ult <4 x i8> [[TMP44]], [[TMP46]]
; SSE-NEXT:    [[TMP52:%.*]] = select <4 x i1> [[TMP51]], <4 x i8> [[TMP50]], <4 x i8> [[TMP48]]
; SSE-NEXT:    [[TMP53:%.*]] = zext <4 x i8> [[TMP52]] to <4 x i32>
; SSE-NEXT:    [[TMP54:%.*]] = mul <4 x i32> [[TMP53]], [[SHUFFLE]]
; SSE-NEXT:    [[TMP55:%.*]] = trunc <4 x i32> [[TMP54]] to <4 x i8>
; SSE-NEXT:    [[TMP56:%.*]] = bitcast i8* [[ARRAYIDX152]] to <4 x i8>*
; SSE-NEXT:    store <4 x i8> [[TMP55]], <4 x i8>* [[TMP56]], align 1
