...
Enabling this function as a whole will cause the size of the generated binary file to swell dramatically. It is recommended to enable this function only for some functions (toObfuscate).
